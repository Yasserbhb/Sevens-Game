...
/**
 * EnhancedSequenceStrategy: A refined strategy that builds on SequenceStrategy's strengths
 ...
 */
class EnhancedSequenceStrategy : public PlayerStrategy {
public:
    EnhancedSequenceStrategy() {
    ...
    virtual ~EnhancedSequenceStrategy() = default;
    ...
    std::string getName() const override {
        return "EnhancedSequenceStrategy";
    }
...
extern "C" sevens::PlayerStrategy* createStrategy() {
    return new sevens::EnhancedSequenceStrategy();
}
#endif