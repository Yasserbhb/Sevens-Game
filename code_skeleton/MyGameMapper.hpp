...
private:
    ...
    // ...
    // Add these to private section of MyGameMapper.hpp
    std::mt19937 rng;
    ...
    void initializeGame(uint64_t numPlayers);
    std::vector<std::pair<uint64_t, uint64_t>> playGame(bool displayOutput);
